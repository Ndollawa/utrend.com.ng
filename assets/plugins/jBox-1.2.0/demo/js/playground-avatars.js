...
function generateAvatarJBox(initial) {
  ...
  var jBoxAvatar = new jBox('Modal', {
        ...
        $(el).on('click', function () {
          ...
          this.animate('slide' + (liked ? 'Right' : 'Left'), {
            ...
            complete: function () {
              ...
              this.animate('popIn', {
                element: $('<div data-avatar-tooltip="You ' + (liked ? 'liked' : 'disliked') + ' ' + DemoAvatars.Avatars[this.AvatarIndex] + '"/>').append($('<div/>').html('<img src="https://stephanwagner.me/images/jBox/avatar/' + DemoAvatars.Avatars[this.AvatarIndex] + '.svg"/>')).appendTo(collectionContainer)
              });
    ...
    onOpen: function () {
      ...
      this.content.css({
        backgroundImage: 'url(https://stephanwagner.me/images/jBox/avatar/' + DemoAvatars.Avatars[DemoAvatars.current] + '.svg)'
      });
