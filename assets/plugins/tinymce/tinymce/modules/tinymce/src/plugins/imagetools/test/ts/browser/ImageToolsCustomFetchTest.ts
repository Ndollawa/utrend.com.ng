...
UnitTest.asynctest('browser.tinymce.plugins.imagetools.ImageToolsCustomFetchTest', (success, failure) => {
  ...
  const srcUrl = '/project/tinymce/src/plugins/imagetools/demo/images/dogleft.jpg';
    ...
    Pipeline.async({}, [
      Log.stepsAsStep('TBA', 'ImageTools: flip image with custom fetch image', [
        ...
        Step.sync(() => {
          ...
          const expectedSrc = document.location.protocol + '//' + document.location.host + '/project/tinymce/src/plugins/imagetools/demo/images/dogleft.jpg';
