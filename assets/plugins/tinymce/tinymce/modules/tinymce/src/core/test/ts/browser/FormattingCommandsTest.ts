...
UnitTest.asynctest('browser.tinymce.core.FormattingCommandsTest', function (success, failure) {
  ...
  suite.test('Formatting commands (alignInline)', function (editor) {
    ...
    editor.setContent('<img src="tinymce/ui/images/raster.gif" />');
    editor.selection.select(editor.dom.select('img')[0]);
    editor.execCommand('JustifyLeft');
    LegacyUnit.equal(editor.getContent(), '<p><img style="float: left;" src="tinymce/ui/images/raster.gif" /></p>');
    ...
    LegacyUnit.equal(
      editor.getContent(),
      '<p><img style="margin-right: auto; margin-left: auto; display: block;" src="tinymce/ui/images/raster.gif" /></p>'
    );

    editor.setContent('<img src="tinymce/ui/images/raster.gif" />');
    editor.selection.select(editor.dom.select('img')[0]);
    editor.execCommand('JustifyRight');
    LegacyUnit.equal(editor.getContent(), '<p><img style="float: right;" src="tinymce/ui/images/raster.gif" /></p>');
  });
