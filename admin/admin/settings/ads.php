											...
											<div class="card-body"> 
												...
												<div class="col-md-12"> 
													<div class="form-group mb-0"> 
														<label class="form-label">Home page Ads 1</label> <textarea rows="10" class="form-control ads-editor" name="home_pageAds1" placeholder="Code here..."><?php echo $home_pageAds1; ?></textarea>
														 </div> 
														</div> 
												<div class="col-md-12"> 
													<div class="form-group mb-0"> 
														<label class="form-label">Home Page Ads 2</label> <textarea rows="10" class="form-control ads-editor" name="home_pageAds2" placeholder="Code here.."><?php echo $home_pageAds2; ?></textarea>
														 </div> 
														</div> 
											
											<div class="col-md-12"> 
													<div class="form-group mb-0"> 
														<label class="form-label">Sidebar Ads </label> <textarea rows="10" class="form-control ads-editor" name="sidebarAds" placeholder="Code here..."><?php echo $sidebarAds; ?></textarea>
														 </div> 
														</div> 
												<div class="col-md-12"> 
													<div class="form-group mb-0"> 
														<label class="form-label">Post page Ads 1</label> <textarea rows="10" class="form-control ads-editor" name="post_Ads1" placeholder="Code here..."><?php echo $post_Ads1; ?></textarea>
														 </div> 
												<div class="col-md-12"> 
													<div class="form-group mb-0"> 
														<label class="form-label">Post Page Ads 2</label> <textarea rows="10" class="form-control ads-editor" name="post_Ads2" placeholder="Code here.."><?php echo $post_Ads2; ?></textarea>
														 </div> 
														</div> 
												<div class="col-md-12"> 
													<div class="form-group mb-0"> 
														<label class="form-label">Post Page Ads 3</label> <textarea rows="10" class="form-control ads-editor" name="post_Ads3" placeholder="Type here.."><?php echo $post_Ads3; ?></textarea>
														 </div> 
														</div> 
												<div class="col-md-12"> 
													<div class="form-group mb-0"> 
														<label class="form-label">Post Page Ads 4</label> <textarea rows="10" class="form-control ads-editor" name="post_Ads4" placeholder="Type here.."><?php echo $post_Ads4; ?></textarea>
														 </div> 
														</div> 
													</div> 
