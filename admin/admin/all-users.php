								...
								<div class="col-sm- 12 col-md-12">
					 				<div class="card-body">
					 					...
					 					<div class="table-responsive table-scrollable">
					 						<form action="" method="post" id="usersdisTable">


											<table class="table table-bordered table-hover table-checkable order-column valign-middle border mb-0 align-items-centerid" id="all_usersTable">
					 							<div class="bulkoptions-container"  style="width:100%; display:inline-flex">
					 								<div class="row" style="width:100%;">
															<div class="col-md-6 col-sm-6 col-6">
																<div class="btn-group " style="margin: 5px 0px;">
																	<a href="create-user.php"
																		class="btn btn-info m-5">
																		Add New <i class="si si-user"></i>
																	</a>
																</div>

											</div><div class="col-md-6 col-sm-6 col-6 d-inline-flex mt-5">
												<select class="form-control bulkoptions-container-tools" id="bulk-options" name="bulk-options" style="width: 200px; margin: 5px 5px;">
