								...
								<div class="col-sm- 12 col-md-12">
					 				<div class="card-body">
					 					...
					 					<div class=""> 
											...
											<table class="table table-responsive table-scrollable table-bordered table-hover table-checkable order-column valign-middle border mb-0 align-items-centerid " id="all_postTable"> 
					 							<div class="bulkoptions-container" style="width:100%;">
