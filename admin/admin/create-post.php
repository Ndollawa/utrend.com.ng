...
$ppost_title = $row['post_title'];	
	 ...
	 header("Location:../content.php?source&p_id=".$post_id."&title=".preg_replace('/ /','+', $ppost_title));
   ...
   $msg ='<h4 style="margin:0 10px 0 10px;" class="alert alert-danger"><center>SORRY: you don\'t have permission for this action!!!</center></h4>';  
}
	...
	?>
								...
								<div class="col-sm- 12 col-md-6">
									...
									<div class="form-group row">
										...
										<div class="col-md-12"><textarea class="editor" row="20" placeholder="Type post contents here..." name="post-content"></textarea>
											</div>
										</div>
											<div class="form-actions" style="margin-top:20px;">
												<div class="row">
													<div class="text-center col-md-12">
														<input type="submit"
															class="btn btn-info m-r-5" name="post-Submit" <?php if (isset($_SESSION['user_acctStatus']) && $_SESSION['user_acctStatus'] != 'Active'){
