...
if($_POST['action'] == 'Notifications'){
				...
				$sql = " SELECT * FROM notification WHERE user_id ='".$receiver_id."' ORDER BY id DESC ";
...
if($_POST['action'] == 'clear_not'){
				...
				$sql = " UPDATE notification SET notification_status = 'read' WHERE user_id ='".$reciever_id."' ORDER BY id DESC ";
				$send = $database->query($sql);
