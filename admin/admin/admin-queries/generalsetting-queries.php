...
$sql = "SELECT brand_image FROM general WHERE id = 1 ";
...
// 	$favicon=  $row['favicon'];
	// $brand_name_logo =  $row['brand_name_logo'];
	 ...
	 $logo =  $row['brand_image'];
$output = '<div style="background-color: #ccc; padding: 10px; border: 2px solid #f68600; border-radius: 2%;" class="container">'; if(!empty($logo)){$output .='<button type="button" class="text-danger m-2 p-2 float-right remove-img" data-tb_column="brand_image" data-action="getlogo" data-imgname="'.$logo.'" style="postion:absolute; z-index:2;top:5px;right:5px;"title="Remove"> <i class="fa fa-trash" style="font-size:1.2em;"></i></button>';}
	$output .='	<img  class="img-responsive" src="../assets/images/'.$logo.'" /></div>';		
		echo $output;
		}
