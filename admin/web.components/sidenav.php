...
<div class='sidebar galaxymag-widget-ready no-items section' id='sidebar1'></div>
<div class='sidebar section' id='social-counter'><div class='widget LinkList' data-version='2' id='LinkList156'>
...
<div class='sidebar galaxymag-widget-ready no-items section' id='sidebar2'></div>
<div class='sidebar sidebar-tabs galaxymag-widget-ready section' id='sidebar-tabs'><div class='widget PopularPosts' data-version='2' id='PopularPosts1'>
<div class='widget-title'>
<h3 class='title'>
Popular
</h3>
...
<div class="custom-widget" id="popularposts">
	<div class="loader-icon"><img src="../assets/images/preloader5.gif" style="width: 150px;" alt="" /></div>
</div>
</div>
...
<div class='sidebar galaxymag-widget-ready section' id='sidebar3'><div class='widget HTML' data-version='2' id='HTML16'>
...
foreach ($send as $row) {
	...
	$sql ="SELECT * FROM posts WHERE (post_tag LIKE '%".$cat_title."%' OR category LIKE '%".$cat_title."%') AND post_status = 'Published' ";
 $result =$database->query($sql);
 $row=$database->fetch_array($result);
 $cat_count = $database->num_rows($result);
