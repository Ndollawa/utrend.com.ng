...
<footer id='footer-wrapper'>
    <div class='container row-x1'>
        <div class='footer-widgets-wrap'>
            <div class='footer galaxymag-widget-ready section' id='footer-sec1'>
            ...
            <div class='footer galaxymag-widget-ready section' id='footer-sec2'>
                <div class='widget HTML' data-version='2' id='HTML4'>
                    ...
                    <div class='widget-content'>
                        <div class="custom-widget" id="recentgadgets">

                            <div class="loader-icon"><img src="../assets/images/preloader6.jpg" style="width: 30px;" alt="" /></div>
                        </div>
                    </div>
                </div>
            </div>
            <div class='footer galaxymag-widget-ready section' id='footer-sec3'>
        ...
        <div class='about-section section' id='about-section'>
    ...
    <div id='sub-footer-wrapper'>
        <div class='container row-x1'>
            <div class='footer-copyright section' id='footer-copyright'>
