...
UnitTest.asynctest('browser.tinymce.core.dom.SerializerTest', function (success, failure) {
  ...
  suite.test('Schema rules', function () {
    ...
    DOM.setHTML('test', '<img title="test" src="tinymce/ui/images/raster.gif" data-mce-src="tinymce/ui/images/raster.gif" alt="test" ' +
      'border="0" style="border: 1px solid red" class="test" /><span id="test2">test</span><hr />');
    LegacyUnit.equal(
      ser.serialize(DOM.get('test'), { getInner: true }),
      '<img title="test" class="test" src="tinymce/ui/images/raster.gif" ' +
    ...
    DOM.setHTML('test', '<br /><hr /><input type="text" name="test" value="val" class="no" />' +
      ...
      'data-mce-href="file.html">link</a><a name="anchor"></a><a>no</a><img src="tinymce/ui/images/raster.gif" ' +
      'data-mce-src="tinymce/ui/images/raster.gif" />');
    LegacyUnit.equal(ser.serialize(DOM.get('test')), '<div id="test"><br /><hr /><input type="text" name="test" value="val" />' +
      ...
      '<a name="anchor"></a>no<img src="tinymce/ui/images/raster.gif" border="0" title="mce_0" /></div>', 'Output name and attribute rules');

    ser.setRules('img[src|border=0|alt=]');
    DOM.setHTML('test', '<img src="tinymce/ui/images/raster.gif" data-mce-src="tinymce/ui/images/raster.gif" border="0" alt="" />');
    LegacyUnit.equal(ser.serialize(DOM.get('test')), '<img src="tinymce/ui/images/raster.gif" border="0" alt="" />', 'Default attribute with empty value');

    ser.setRules('img[src|border=0|alt=],div[style|id],*[*]');
    DOM.setHTML('test', '<img src="tinymce/ui/images/raster.gif" data-mce-src="tinymce/ui/images/raster.gif" /><hr />');
    LegacyUnit.equal(
      ser.serialize(DOM.get('test'), { getInner: true }),
      '<img src="tinymce/ui/images/raster.gif" border="0" alt="" /><hr />'
    );
    ...
    DOM.setHTML('test', '<img src="tinymce/ui/images/raster.gif" data-mce-src="tinymce/ui/images/raster.gif" alt="" />');
    LegacyUnit.equal(
      ser.serialize(DOM.get('test')),
      '<div id="test"><img src="tinymce/ui/images/raster.gif" alt="" /></div>'
    );

    ser = Serializer({ invalid_elements : 'hr,br' });
    DOM.setHTML('test', '<img src="tinymce/ui/images/raster.gif" data-mce-src="tinymce/ui/images/raster.gif" /><hr /><br />');
    LegacyUnit.equal(
      ser.serialize(DOM.get('test'), { getInner: true }),
      '<img src="tinymce/ui/images/raster.gif" />'
    );
  });
