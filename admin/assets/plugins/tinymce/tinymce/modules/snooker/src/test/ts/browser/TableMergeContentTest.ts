  ...
  const spec1 = [
    {
      ...
      expected: '<p>There should not be a br after.</p><p>Standard paragraph</p> I am a textnode and should have a br after the period.<br><img src="/project/@ephox/snooker/src/assets/images/ephox_nav.png"><br><span><div>Nested div<p> deep para</p></div> <span>nested span</span>there SHOULD be a br proceeding the span</span><br>'
    },
    {
...

    {
      ...
      html: '<img src="/project/@ephox/snooker/src/assets/images/ephox_nav.png">',
      expected: ''
    },
    {
  ...
  const spec2 = [
    {
      ...
      expected: 'standard issue textnode <p>There should not be a br after.</p><a href="/"><img src="/project/@ephox/snooker/src/assets/images/ephox_nav.png"> I am inline textnode</a><br>textnode with empty block tag <div></div>'
    },
    {
      label: 'Img wrapped in an Anchor tag with text, there should be a BR after',
      html: '<a href="/"><img src="/project/@ephox/snooker/src/assets/images/ephox_nav.png"> I am inline textnode</a>',
      expected: ''
    },
    {
  ...
  const spec6 = [
    {
      ...
      html: '<img src="/project/@ephox/snooker/src/assets/images/ephox_nav.png">',
      expected: '<img src="/project/@ephox/snooker/src/assets/images/ephox_nav.png"><br><hr>'
    },
    {
      label: 'A cell containing an image and an hr should maintain both',
      html: '<hr>',
