...
body{position:relative;background-color:#f5f5f5; <?php if(!empty($bg_image)){ echo "url('../images/{$bg_image}')";}else{ echo "background:#f5f5f5";} ?> repeat scroll top left;font-family:var(--body-font);font-size:13px;color:#656565;font-weight:300;font-style:normal;line-height:1.4em;word-wrap:break-word;margin:0;padding:0}
.rtl{direction:rtl}
...
.entry-title{color:<?php echo $theme_colour_one; ?>;text-align:auto;}
...
#galaxymag-main-menu ul div{transition:all .17s ease}
...
#galaxymag-main-menu .mega-menu > ul.mega-widget,#galaxymag-main-menu .mega-menu > .complex-tabs{overflow:hidden}
#galaxymag-main-menu .mega-menu > .complex-tabs > ul.select-tab{position:relative;float:left;width:20%;box-sizing:border-box;padding:20px 0;margin:-20px 0 0 -10px}
.rtl #galaxymag-main-menu .mega-menu > div.complex-tabs > ul.select-tab{float:right;margin:-20px -10px 0 0}
#galaxymag-main-menu .mega-menu > .complex-tabs > ul.select-tab:before{content:'';position:absolute;left:0;top:0;width:100%;height:100vh;background-color:rgba(155,155,155,0.07);box-sizing:border-box;display:block}
#galaxymag-main-menu .mega-menu > .complex-tabs > ul.select-tab > li{width:100%;margin:0}
#galaxymag-main-menu ul > li > .complex-tabs > ul.select-tab > li > a{position:relative;display:block;height:auto;font-size:13px;color:#f2f2f2;line-height:33px;padding:0 20px}
#galaxymag-main-menu .mega-menu > .complex-tabs > ul.select-tab > li.active > a:after{content:'\f054';font-family:'Font Awesome 5 Free';font-weight:900;font-size:9px;float:right}
.rtl #galaxymag-main-menu .mega-menu > .complex-tabs > ul.select-tab > li.active > a:after{content:'\f053';float:left}
#galaxymag-main-menu .mega-menu > .complex-tabs > ul.select-tab > li.active,#galaxymag-main-menu .mega-menu > .complex-tabs > ul.select-tab > li:hover{background-color:<?php echo $theme_colour_two; ?>}
#galaxymag-main-menu .mega-menu > .complex-tabs > ul.select-tab > li.active > a,#galaxymag-main-menu .mega-menu > .complex-tabs > ul.select-tab > li:hover > a{color:#ffffff}
...
.item-post .post-body{position:relative;float:left;width:100%;overflow:hidden;font-family:var(--body-font);font-size:15px;color:#656565;line-height:1.6em;padding:25px 0 0;margin:0;min-height:100vh}
...
.image-caption .excerpt{text-align:justify;}
...
.pager > li active {
    background:<?php echo $theme_colour_two;?>!important ;
    color:white;
}
.pagination-active {
    background:<?php echo $theme_colour_two;?>!important ;
...
.pagination-not-active{
 background:<?php echo $theme_colour_one;?>!important ;
    color:white;
}
