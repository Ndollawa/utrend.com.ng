			...
			<div class="page-main">
				<div class="app-header header py-1 d-flex">
					<div class="container-fluid">
						<div class="d-flex">
							<a class="header-brand" href="../index.php"> <img src="../assets/images/<?php echo $brand_name_logo; ?>" class="header-brand-img" alt="<?php echo $website_name; ?> logo"/> </a> <a aria-label="Hide Sidebar" class="app-sidebar__toggle" data-toggle="sidebar" href="#"></a>
