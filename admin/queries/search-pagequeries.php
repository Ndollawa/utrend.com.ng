...
$sql = "SELECT * FROM posts WHERE post_status = 'Published' AND author = '".$_POST['sdata']."' ORDER BY id DESC ";
...
if($pages>1){
$output .= '<li ><button style="border-radius:40%; padding:2px 6px; margin:0 2px;" class="btn btn-sm pagination-not-active pager-nav';
...
$output .= '<li ><button style="border-radius:40%; padding:2px 6px; margin:0 2px;" class="btn btn-sm pagination-not-active innerpager-nav';
...
if($i <1){
 ...
 for ($i+1; $i <= $pagercount ; $i++) {
 	if ($i==$page) {
 			$output .= '<li ><button style="border-radius:40%; padding:2px 6px; margin:0 2px;" class="btn btn-sm pagination-active" id="" data-pagenum="'.$i.'" data-tpages="'.$pages.'">'.$i.'</button></li>';
}else{
 	
	$output .= '<li ><button style="border-radius:40%; padding:2px 6px; margin:0 2px;" class="btn btn-sm pagination-not-active pagination" id="" data-pagenum="'.$i.'" data-tpages="'.$pages.'">'.$i.'</button></li>';}
}
$output .= '<li ><button style="border-radius:40%; padding:2px 6px; margin:0 2px;" class="btn btn-sm pagination-not-active innerpager-nav';
...
';
  ...
  echo '<div class="container jumbotron d-flex d-flex-justify-center " style="margin: auto; align-content: center;vertical-align:middle;  padding: auto;min-height:100vh;"><center><h3 align="center" style="vertical-align:middle; margin-top:50%; margin-bottom:50%;">SORRY...</br>No Posts yet!!!</h3></center></div>';
		}
