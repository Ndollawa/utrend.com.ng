...
if(isset($_POST['update-siteprofile'])){
  ...
  $destination = '../assets/images/';
	...
	echo $theme_color1 =  $database->escape_value($_POST['theme-color1']);
	echo $theme_color2 =  $database->escape_value($_POST['theme-color2']);
	echo $theme_link =  $database->escape_value($_POST['theme-link-color']);
